            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="space-y-5">
                    {filteredProblems.length === 0 ? (
                        ...
                        filteredProblems.map((problem, index) => (
                            //   <div
                            //     key={problem.id}
                            //     className="group relative bg-gradient-to-br from-white to-blue-50/40 backdrop-blur-sm rounded-2xl border border-blue-500/30 hover:border-indigo-500/50 shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:scale-[1.02] cursor-pointer overflow-hidden"
                            //   >
                            //     {/* Animated gradient overlay */}
                            //     <div className="absolute inset-0 bg-gradient-to-r from-white to-blue-50/40 group-hover:from-blue-600/10 group-hover:via-indigo-600/10 group-hover:to-blue-600/10 transition-all duration-500"></div>

                            //     {/* Glow effect */}
                            //     <div className="absolute -inset-1 bg-gradient-to-r from-white to-blue-50/40 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-all duration-500"></div>
                            ...
                            //             <div className="w-6 h-6 rounded-xl bg-gradient-to-br from-blue-500 via-indigo-500 to-blue-700 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg shadow-blue-500/50">
                            //               <MdCode className="w-4 h-4 text-white" />
                            //             </div>
                            //             <div className="flex-1">
                            //               <div className="flex items-center gap-3 mb-2 flex-wrap">
                            //                 <h2 className="text-xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent group-hover:from-blue-400 group-hover:to-blue-400 transition-all duration-300">
                            //                   {problem.title}
                            //                 </h2>
                            ...
                            //         {/* RIGHT SIDE */}
                            //         <div className="flex flex-col items-center gap-2 bg-gradient-to-br from-white to-blue-50/40 px-5 py-4 rounded-xl border border-blue-500/30 group-hover:border-indigo-500/50 transition-all duration-300 shadow-lg">
                                    ...
                                    <div className="flex items-center justify-between gap-6">
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-5 mb-4">
                                                ...
                                                {/* ICON */}
                                                <div className="w-8 h-8 rounded-xl bg-blue-500 flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-sm">
                                                    <MdCode className="w-4 h-4 text-white" />
                                                </div>
                                        ...
                                        <div className="flex flex-col items-center gap-2 bg-blue-50 px-5 py-4 rounded-xl border border-blue-200 transition-all duration-300">
                                            ...
                                            <MdChevronRight className="w-6 h-6 text-blue-500 group-hover:translate-x-2 transition-all duration-300" />
                                        </div>
                ...
                <div className="mt-16 relative bg-gradient-to-br from-gray-900/20 via-gray-900/40 to-gray-900/20 backdrop-blur-sm rounded-2xl border border-gray-400/20 shadow-2xl overflow-hidden">
                    ...
                    <div className="relative p-8">
                        <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent">
                            Statistics Overview
                        </h3>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="group text-center p-6 bg-gradient-to-br from-white/10 via-gray-200/10 to-white/10 rounded-xl border border-gray-300/20 hover:border-gray-200/40 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-white/20">
                                <div className="text-sm font-semibold text-gray-200 mb-2">Total Problems</div>
